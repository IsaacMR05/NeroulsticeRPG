...
public class HurtEnemy : MonoBehaviour
{
    ...
    private void OnTriggerEnter2D(Collider2D other)
    {
        ...
        {
            case 0:
                if (other.tag == "Enemy" || other.tag == "RangedEnemy" || other.tag == "Boss" || other.tag == "Invoked") 
                {
            ...
            case 1:
                ...
                if (other.tag == "Enemy" || other.tag == "RangedEnemy" || other.tag == "Boss" || other.tag == "Invoked") //només te el tag el slime
                {
